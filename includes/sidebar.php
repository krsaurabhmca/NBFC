...
<aside class="w-64 bg-slate-900 text-white flex flex-col shadow-xl">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        <a href="/nbfc/index.php" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'index.php' ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-900/50' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <a href="/nbfc/members/add.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'add.php' ? 'bg-emerald-600/10 text-emerald-400 border border-emerald-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <a href="/nbfc/members/list.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'list.php' ? 'bg-emerald-600/10 text-emerald-400 border border-emerald-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <a href="/nbfc/accounts/open.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'open.php' ? 'bg-blue-600/10 text-blue-400 border border-blue-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <a href="/nbfc/accounts/view.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'view.php' ? 'bg-blue-600/10 text-blue-400 border border-blue-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <a href="/nbfc/accounts/closure.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'closure.php' ? 'bg-blue-600/10 text-blue-400 border border-blue-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <a href="/nbfc/transactions/process.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'process.php' ? 'bg-rose-600/10 text-rose-400 border border-rose-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <a href="/nbfc/advisor/collect.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'collect.php' ? 'bg-amber-600/10 text-amber-400 border border-amber-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <a href="/nbfc/advisor/wallet_history.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'wallet_history.php' ? 'bg-amber-600/10 text-amber-400 border border-amber-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <?php if($_SESSION['role'] == 'admin'): ?>
        <a href="/nbfc/reports/index.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'index.php' && strpos($_SERVER['REQUEST_URI'], 'reports') !== false ? 'bg-indigo-600/10 text-indigo-400 border border-indigo-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <a href="/nbfc/transactions/advisor_txns.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'advisor_txns.php' ? 'bg-indigo-600/10 text-indigo-400 border border-indigo-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <a href="/nbfc/users/index.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'index.php' && strpos($_SERVER['REQUEST_URI'], 'users') !== false ? 'bg-violet-600/10 text-violet-400 border border-violet-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <a href="/nbfc/settings/general.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= strpos($_SERVER['REQUEST_URI'], 'settings') !== false ? 'bg-violet-600/10 text-violet-400 border border-violet-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
            <i class="ph ph-gear text-xl text-violet-500 group-hover:scale-110 transition-transform"></i> 
            <span class="font-medium">System Settings</span>
        </a>
        <?php endif; ?>
        <a href="/nbfc/help/calculations.php" class="group flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all <?= $current_page == 'calculations.php' ? 'bg-sky-600/10 text-sky-400 border border-sky-500/20' : 'text-slate-300 hover:bg-slate-800 hover:text-white' ?>">
        ...
        <div class="flex items-center gap-4">
            <div class="relative group">
                ...
                <div id="profileDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-gray-100 z-50 overflow-hidden py-1">
                    ...
                    <a href="/nbfc/profile/password.php" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 transition-colors">
                        <i class="ph ph-key"></i> Change Password
                    </a>
                    <div class="h-px bg-gray-50 my-1"></div>
                    <a href="/nbfc/logout.php" class="flex items-center gap-2 px-4 py-2 text-sm text-rose-600 hover:bg-rose-50 transition-colors">
